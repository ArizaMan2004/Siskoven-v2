...
interface SidebarProps {
  ...
  /** "Dueño", "Encargado" o "Cajero": quien usa la caja debe saber con qué permisos entró. */
    ...
    <aside className="bg-sidebar border-sidebar-border fixed inset-y-0 left-0 z-30 hidden w-64 flex-col border-r lg:flex">
      ...
      <div className="border-sidebar-border space-y-3 border-t p-3">
        ...
        <div className="min-w-0 px-2">
          ...
          {roleLabel ? (
            <span className="bg-secondary text-secondary-foreground mt-1.5 inline-block rounded-full px-2 py-0.5 text-[11px] font-medium">
              {roleLabel}
            </span>
          ) : null}
        </div>

        <Button variant="ghost" onClick={onLogout} className="text-muted-foreground w-full justify-start gap-2">
